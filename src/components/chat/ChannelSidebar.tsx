      ...
      <div className="flex-1 overflow-y-auto scrollbar-thin px-3 py-4">
          ...
          {channels.map((c) => {
            ...
            return (
              <button
                ...
                className={`group flex w-full items-center gap-2 rounded-md px-2 py-1.5 text-sm font-medium transition-all ${
                  active
        ...
        {admin && (
          <>
            ...
            <Link
              to="/admin"
              className="flex w-full items-center gap-2 rounded-md px-2 py-1.5 text-sm font-medium text-muted-foreground transition-all hover:bg-sidebar-accent/60 hover:text-foreground"
            >
